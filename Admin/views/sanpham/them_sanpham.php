<div class="container">
    <form method="post" action="index.php?controller=xuly&action=themsp" class="row" enctype='multipart/form-data'>
        ...
        <div class="mb-3 col-6">
            ...
            <input name="gpu" class="form-control" type="text">
        </div>

        <div class="mb-3 col-6">
            <label class="form-label">Webcam</label>
            <input name="webcam" class="form-control" type="text">
        </div>
        ...
        <div class="mb-3 col-6">
            ...
            <input name="trongluong" class="form-control" type="text">
        </div>

        <div class="mb-3 col-6">
            <label class="form-label">Bảo hành</label>
            <input name="baohanh" class="form-control" type="text">
        </div>
